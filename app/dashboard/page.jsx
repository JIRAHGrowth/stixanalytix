...
export default function DashboardPage() {
  ...
  const toggleRankings = async (mid) => { if(!rankingsEnabled || isKeeperUnder18()) return; if(expandedRankings===mid){setExpandedRankings(null);return;} setExpandedRankings(mid);setExpandedNotes(null); await fetchRankingContent(mid); };
          ...
          {tab === "overview" && s && (
            ...
            {hasMatches && tab === "matches" && (
              <div>
                ...
                <td style={{ padding: "4px 6px", textAlign: "center" }} onClick={e => e.stopPropagation()}><StatusIcon state={(rankingsEnabled && !isKeeperUnder18()) ? getIconState(rankingsStatus, m.id) : "rankings-off"} onClick={() => toggleRankings(m.id)} /></td>
